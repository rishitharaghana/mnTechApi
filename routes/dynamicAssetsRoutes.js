...
router.post("/service/:id/serviceItem", dynamicAssetsController.service);
router.put("/service/:id/serviceItem/:itemId", dynamicAssetsController.service);
router.delete("/service/:id/serviceItem/:itemId", dynamicAssetsController.service);
