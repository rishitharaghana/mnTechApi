...
const dynamicAssets = require("../controllers/dynamicAssets");
...
router.get("/team/",dynamicAssets.team);
router.get("/team/:id",dynamicAssets.team);
router.post("/team/",dynamicAssets.team);
router.put("/team/:id",dynamicAssets.team);
router.delete("/team/:id",dynamicAssets.team);
